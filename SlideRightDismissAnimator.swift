//
//  SlideRightDismissAnimator.swift
//  Govi
//
//  Created by RomanC on 6/1/17.
//  2017 SapienSolutions, LLC.
/*
 *   Animation class that will slide a view(fromView) to the right, revealing the toView.
 *   Modify the duration variable to preference.
 */

import UIKit

class SlideRightDismissAnimator: NSObject, UIViewControllerAnimatedTransitioning {
