...
/*
 *   Animation class that will slide both views(to and from views) to the right.
...
class SlideUpAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate{
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: durationStatic, delay: 0.0, options: .curveEaseInOut,
                       animations: {
